      ...
      <div className="container py-10 px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 md:gap-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-muted-foreground hover:text-purple transition-colors">Instagram</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-purple transition-colors">LinkedIn</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-purple transition-colors">Behance</a></li>
                <li><a href="#" className="text-muted-foreground hover:text-purple transition-colors">Dribbble</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 mt-10 pt-6 text-center">
          <p className="text-sm text-muted-foreground flex items-center justify-center">
            Made with 
            <Heart className="text-coral mx-1" size={16} />
