            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:contact@ujjwaljain.design" className="text-muted-foreground hover:text-purple transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+911234567890" className="text-muted-foreground hover:text-coral transition-colors">
                    +91 123 456 7890
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                <div className="p-3 rounded-full bg-turquoise/10">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Textarea
                    ...
                    className="min-h-[150px] border-gray-200 focus-visible:ring-purple"
                    required
                  />
                </div>
                
                <Button type="submit" className="bg-purple hover:bg-purple/90 text-white w-full">
